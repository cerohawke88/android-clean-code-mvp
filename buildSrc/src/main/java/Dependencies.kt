...
object BuildConfigs {
    const val ApiUrl = "\"https://github-trending-api.now.sh/\""
}
object Version {
    //common
...
object Android {
    ...
    val support = "com.android.support:support-v4:28.0.0"
}
...
object Room {
    ...
    val compiler = "android.arch.persistence.room:compiler:${Version.room}"
    val testing = "android.arch.persistence.room:testing:${Version.room}"
}
...
object Rx {
    val java = "io.reactivex.rxjava2:rxandroid:2.1.0"
